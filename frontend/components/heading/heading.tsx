    ...
    return (
        <>
            <div className="relative my-10 px-8 z-20">
                <div
                    className="outline-none flex flex-col justtify-start shrink-0 opacity-5 transition -top-32 2xl:-24 w-[71px] flex-none h-auto left-4 lg:left-12 absolute whitespace-pre">
                ...
                <div className="flex items-center flex-nowrap min-h-min overflow-hidden p-0 w-full font-oswald">
                    ...
                    <HeadingAnimatedSvg text={"PROFESSIONAL BRIDGE ENGINEER"} />
