        ...
        <nav className="bg-black shadow-lg shadow-white/[0.03] backdrop-blur-[0.5rem] sm:top-6 sm:h-[4rem] sm::w-[36rem]">
                ...
                <div className="relative flex h-16 items-center justify-between">
                    ...
                    <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                        <div className={`flex flex-shrink-0 items-center`}>
                            <Link to="/"> <img className={`h-8 w-auto block md:block sm:hidden ${icon ? '' : ' hidden'}`} src="/kuroyuki.png" alt="Kuroyuki"/> </Link>
                        </div>
            ...
            <div className={`sm:hidden ${isMobileMenuOpen ? '' : 'hidden'}`} id="mobile-menu">
                <div className="space-y-1 px-2 pb-3 pt-2">
                    ...
                    <Link to="/about" className="text-gray-300 hover:bg-gray-700 hover:text-white block rounded-md px-3 py-2 text-base font-medium">About me</Link>
                </div>
            </div>
        </nav>
    );
